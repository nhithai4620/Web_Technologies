        ...
        <section id="inner" class="inner-section section">
                ...
                <div class="inner-wrapper row">
                    <div class="col-md-12">
                        ...
                        <a href="/apps/lab3/www/add-contact.php" class="btn btn-primary" style="margin-bottom: 30px;">
                        ...
                        <table id="contacts" class="table table-bordered table-responsive table-striped">
                            ...
                            <tbody>
                                <?php foreach($contacts as $contact): ?>
                                    ...
                                    <td><?=htmlspecialchars(date("d-m-Y",
                                    strtotime($contact->created_at)))?></td>
                                    <td><?=htmlspecialchars($contact->notes)?></td>
                                    <td><a href="/apps/lab3/www/edit-contact.php?id=<?=htmlspecialchars($contact->id)?>"
                                    class="btn btn-xs btn-warning">
                                    <i alt="Edit" class="fa fa-pencil"> Edit</i></a>
                                    <form class="delete" action="/apps/lab3/www/del-contact.php"
